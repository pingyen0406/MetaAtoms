function field=Focal_Slice_2(Phase,T,atomPos,x_range,y_range,z,x_res,y_res,...
    lambda,symmetry)
...
elseif symmetry==true  
    ...
    tmp_field = pointSource_field(Phase,T,atomPos,x_list(x_len+1:end),...
        zeros(1,y_len),z,lambda,type);
